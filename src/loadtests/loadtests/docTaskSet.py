...
class docTaskSet(TaskSet):
    ...
    def newFilesDocx(self):
        ...
        '''
        self.createdDocuments.append(newFilesDocxShared(self))
    ...
    def newFilesXlsx(self):
        ...
        Deletes the doument after finishing the task.
        '''
        self.createdDocuments.append(newFilesXlsxShared(self))
    ...
    def newFilesPptx(self):
        ...
        Deletes the doument after finishing the task.
        '''
        self.createdDocuments.append(newFilesPptxShared(self))